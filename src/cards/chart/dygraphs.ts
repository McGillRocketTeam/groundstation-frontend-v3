// credit to YAMCS
//
// https://github.com/yamcs/yamcs/blob/master/yamcs-web/src/main/webapp/projects/webapp/src/app/shared/parameter-plot/dygraphs.ts
//

import { ParameterType } from "@/lib/yamcsClient/lib/client";
