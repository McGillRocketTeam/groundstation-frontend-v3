...
export function valToStr(value: Value): string {
  switch (value.type) {
    case "AGGREGATE":
      return value.aggregateValue!.value.join(" ");
    case "STRING":
    ...
    case "SINT32":
      return value.sint32Value!.toString();
    case "SINT64":
      return value.sint64Value!.toString();
    case "UINT32":
      return value.uint32Value!.toString();
    case "UINT64":
      return value.uint64Value!.toString();
    case "BINARY":
