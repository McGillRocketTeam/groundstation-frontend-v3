...
export default class YamcsClient implements HttpHandler {
  ...
  createInstancesSubscription(
    ...
    return <InstancesSubscription>(
      this.webSocketClient!.createSubscription("instances", {}, observer)
    );
  }
  ...
  createSessionSubscription(
    ...
    return <SessionSubscription>(
      this.webSocketClient!.createSubscription("session", {}, observer)
    );
  }
  ...
  createTimeSubscription(
    ...
    return <TimeSubscription>(
      this.webSocketClient!.createSubscription("time", options, observer)
    );
  }
  ...
  createReplicationInfoSubscription(
    ...
    return <ReplicationInfoSubscription>(
      this.webSocketClient!.createSubscription("replication-info", {}, observer)
    );
  }
  ...
  createSystemInfoSubscription(
    ...
    return <SystemInfoSubscription>(
      this.webSocketClient!.createSubscription("sysinfo", {}, observer)
    );
  }
  ...
  createHttpTrafficSubscription(
    ...
    return <HttpTrafficSubscription>(
      this.webSocketClient!.createSubscription("http-traffic", {}, observer)
    );
  }
  ...
  createClearanceSubscription(
    ...
    return <ClearanceSubscription>(
      this.webSocketClient!.createSubscription("clearance", {}, observer)
    );
  }
  ...
  createProcessorSubscription(
    ...
    return <ProcessorSubscription>(
      this.webSocketClient!.createSubscription("processors", options, observer)
    );
  }
  ...
  createBackfillingSubscription(
    ...
    return <BackfillingSubscription>(
      this.webSocketClient!.createSubscription("backfilling", options, observer)
    );
  }
  ...
  createCop1Subscription(
    ...
    return <Cop1Subscription>(
      this.webSocketClient!.createSubscription("cop1", options, observer)
    );
  }
  ...
  createGlobalAlarmStatusSubscription(
    ...
    return <GlobalAlarmStatusSubscription>(
  ...
  createGlobalActivityStatusSubscription(
    ...
    return <GlobalActivityStatusSubscription>(
      this.webSocketClient!.createSubscription(
  ...
  createTMStatisticsSubscription(
    ...
    return <TMStatisticsSubscription>(
      this.webSocketClient!.createSubscription("tmstats", options, observer)
    );
  }
  ...
  createAlgorithmStatusSubscription(
    ...
    return <AlgorithmStatusSubscription>(
      this.webSocketClient!.createSubscription(
        "algorithm-status",
        options,
        observer,
  ...
  createEventSubscription(
    ...
    return <EventSubscription>(
      this.webSocketClient!.createSubscription("events", options, observer)
    );
  }
  ...
  createActivitySubscription(
    ...
    return <ActivitySubscription>(
      this.webSocketClient!.createSubscription("activities", options, observer)
    );
  }
  ...
  createActivityLogSubscription(
    ...
    return <ActivityLogSubscription>(
      this.webSocketClient!.createSubscription(
        "activity-log",
        options,
        observer,
  ...
  createRemoteFileListSubscription(
    ...
    return <RemoteFileListSubscription>(
      this.webSocketClient!.createSubscription(
        "remote-file-list",
        options,
        observer,
  ...
  createParseFilterSubscription(
    ...
    return <ParseFilterSubscription>(
      this.webSocketClient!.createSubscription(
        "web.parse-filter",
        options,
        observer,
  ...
  createStreamStatisticsSubscription(
    ...
    return <StreamStatisticsSubscription>(
      this.webSocketClient!.createSubscription(
        "stream-stats",
        options,
        observer,
  ...
  createQueueStatisticsSubscription(
    ...
    return <QueueStatisticsSubscription>(
      this.webSocketClient!.createSubscription("queue-stats", options, observer)
    );
  }
  ...
  createQueueEventsSubscription(
    ...
    return <QueueEventsSubscription>(
      this.webSocketClient!.createSubscription(
        "queue-events",
        options,
        observer,
  ...
  createAlarmSubscription(
    ...
    return <AlarmSubscription>(
      this.webSocketClient!.createSubscription("alarms", options, observer)
    );
  }
  ...
  createCommandSubscription(
    ...
    return <CommandSubscription>(
      this.webSocketClient!.createSubscription("commands", options, observer)
    );
  }
  ...
  async getFileList(
    ...
    const indexedRequest: { [key: string]: any } = request;
    const url2 =
      url +
      this.queryString(
  ...
  prepareWebSocketClient() {
    if (!this.webSocketClient) {
      this.webSocketClient = new WebSocketClient(this.frameLossListener);
