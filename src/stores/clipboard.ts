...
const createClipboardStore = <T>(key: string) => create<ClipboardStore<T>>()(
  persist(
    (set, get) => ({
      value: null,
      copy: (value) => {
...
export const usePanelClipboardStore = createClipboardStore<PanelCipboardItem>("mrt_panel_clipboard")
